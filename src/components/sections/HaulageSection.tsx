...
export function HaulageHomeSection() {
  return (
    <section className="py-12 md:py-20 lg:py-16 md:py-24 bg-slate-900 text-white relative overflow-hidden border-y border-slate-800">
      {/* Background overlay */}
      <div 
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {HOMEPAGE_HAULAGE_HIGHLIGHTS.map((item, idx) => {
            return (
              <motion.div
                ...
                className="bg-slate-800/80 rounded-xl overflow-hidden border border-slate-700/80 hover:border-accent/50 transition-all duration-300 flex flex-col group hover:-translate-y-1 shadow-lg"
              >
        ...
        {/* Feature badges row */}
        <div className="p-6 rounded-xl bg-white/5 border border-white/10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-xs sm:text-sm">
