...
export function AboutSection() {
  return (
    <section id="about" className="py-12 md:py-20 lg:py-16 md:py-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div 
            ...
            className="relative"
          >
            <div className="aspect-[4/3] rounded-xl overflow-hidden shadow-2xl shadow-black/10 border border-gray-100">
              <img 
            ...
            <div className="absolute bottom-4 right-4 sm:-bottom-8 sm:-right-8 bg-primary text-white p-6 sm:p-7 rounded-xl shadow-2xl max-w-xs border border-white/10">
...
export function ServicesSection() {
  return (
    <section className="py-12 md:py-20 lg:py-16 md:py-24 bg-slate-50/70 relative border-y border-gray-200/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {SERVICES.map((service, idx) => {
            ...
            return (
              <motion.div
                ...
                className="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl border border-gray-200/80 hover:border-accent/30 transition-all duration-300 flex flex-col h-full hover:-translate-y-1.5"
              >
                {/* Card Image */}
                ...
                <div className="p-6 sm:p-7 flex-1 flex flex-col relative">
                  ...
                  <div className="mt-auto pt-4 border-t border-gray-100 space-y-3">
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                      <Link 
                        to={linkHref} 
                        className="flex-1 bg-primary hover:bg-black text-white text-center py-2.5 px-3 text-xs sm:text-sm font-bold transition-all shadow-sm flex items-center justify-center gap-1 min-h-[40px] rounded-full"
                      >
                        <span>Book for Repair</span>
                      </Link>
                      <a 
                        href="tel:0244753849" 
                        className="flex-1 bg-accent hover:bg-accent/90 text-white text-center py-2.5 px-3 text-xs sm:text-sm font-bold transition-all shadow-sm shadow-accent/20 flex items-center justify-center gap-1.5 min-h-[40px] rounded-full"
                      >
        ...
        <div className="mt-14 text-center">
          <Link 
            to="/services" 
            className="bg-accent hover:bg-accent/90 text-white px-4 sm:px-8 sm:px-5 sm:px-8 md:px-10 py-4 font-bold transition-all shadow-md shadow-accent/25 hover:shadow-accent/40 hover:-translate-y-0.5 inline-flex items-center gap-2 rounded-full"
          >
...
export function TowingServicesHomeSection() {
  return (
    <section className="py-12 md:py-20 lg:py-16 md:py-24 bg-white overflow-hidden border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
