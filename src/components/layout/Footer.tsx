        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 mb-14">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3 text-sm">
              ...
              <a href="mailto:santatowing.garage@gmail.com" className="flex items-center gap-3 text-white/80 hover:text-accent transition-colors">
                <div className="w-8 h-8 rounded-xl bg-primary/30 flex items-center justify-center text-white">
                  <Mail className="w-4 h-4" />
                </div>
                <span>santatowing.garage@gmail.com</span>
              </a>
