  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/30 text-white transition-all shadow-lg hover:shadow-xl hover:scale-110"
      >
