...
export default function PrivacyPolicy() {
  return (
    <main className="pt-24 lg:pt-[104px] bg-slate-50 min-h-screen">
      ...
      {/* Page Header */}
      <section className="bg-dark text-white py-10 md:py-16 md:py-16 md:py-24 relative overflow-hidden">
      ...
      {/* Content Section */}
      <section className="py-10 md:py-16 md:py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4">
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="bg-white p-6 sm:p-8 md:p-12 rounded-xl shadow-sm border border-dark/10"
          >
            <div className="prose prose-slate max-w-none prose-headings:text-dark prose-p:text-dark/80 prose-a:text-primary">
              ...
              <div className="bg-slate-50 p-6 rounded-xl mt-6 border border-dark/10 flex flex-col sm:flex-row gap-6">
                <div className="flex items-center gap-3 text-dark/80">
                  ...
                  <span className="font-medium">santatowing.garage@gmail.com</span>
                </div>
                <div className="flex items-center gap-3 text-dark/80">
                  <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center text-primary shrink-0">
