      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 relative">
          ...
          <div className="w-full lg:w-2/3">
            ...
            {/* 2. Product Gallery */}
            <div className="bg-white rounded-xl p-4 border border-dark/10 shadow-sm mb-12">
              <div className="aspect-[4/3] md:aspect-video rounded-xl overflow-hidden bg-white mb-4 relative group cursor-zoom-in">
                <img 
            ...
            <div className="bg-white rounded-xl border border-dark/10 shadow-sm mb-12 overflow-hidden">
              ...
              <div className="p-6 md:p-6 sm:p-8">
                {activeTab === 'specs' && (
            ...
            <div className="bg-primary rounded-xl p-6 sm:p-8 md:p-12 text-white mb-12 relative overflow-hidden">
                ...
                return (
                  <>
                    <div className="w-full sm:w-1/2 flex justify-start">
                      {prevPart && (
                        <Link to={`/parts/${prevPart.id}`} className="group flex items-center gap-3 hover:bg-slate-50 p-3 rounded-xl transition-colors max-w-full">
                    ...
                    <div className="w-full sm:w-1/2 flex justify-end">
                      {nextPart && (
                        <Link to={`/parts/${nextPart.id}`} className="group flex items-center gap-3 hover:bg-slate-50 p-3 rounded-xl transition-colors max-w-full text-right">
                          <div className="overflow-hidden">
          ...
          <div className="w-full lg:w-1/3">
            <div className="bg-white rounded-xl p-6 md:p-6 sm:p-8 border border-dark/10 shadow-xl lg:sticky lg:top-32">
              ...
              <div className="flex items-center gap-4 mb-6 border-b border-dark/10 pb-6">
                ...
                <div className="flex items-center bg-white rounded-xl border border-dark/20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {RELATED_PRODUCTS.map((product) => (
              <Link to={`/parts/${product.id}`} key={product.id} className="bg-white rounded-xl p-4 border border-dark/10 hover:shadow-xl transition-all group flex flex-col">
                <div className="aspect-[4/3] rounded-xl overflow-hidden mb-4 bg-white relative">
