...
const CONTACT_OPTIONS = [
  ...
  { id: 4, title: 'Email Us', value: 'santatowing.garage@gmail.com', icon: Mail, color: 'text-dark', bg: 'bg-dark/5', action: 'Send Email', href: 'mailto:santatowing.garage@gmail.com' },
];
...
const DEPARTMENTS = [
  { name: 'Vehicle Sales', phone: '0244753849', email: 'santatowing.garage@gmail.com', icon: Car },
  { name: 'Service & Repairs', phone: '0244753849', email: 'santatowing.garage@gmail.com', icon: Wrench },
  { name: 'Fleet & B2B', phone: '0244753849', email: 'santatowing.garage@gmail.com', icon: ShieldCheck },
];
...
export default function Contact() {
  ...
  return (
    <main className="pt-24 lg:pt-[104px] min-h-screen bg-white">
      ...
      {/* 1. Hero Banner */}
      <section className="relative bg-primary text-white py-16 md:py-16 md:py-24 lg:py-32 overflow-hidden">
            ...
            {CONTACT_OPTIONS.map((option, idx) => {
              ...
              return (
                <motion.div 
                  ...
                  className="bg-white rounded-xl p-6 border border-dark/10 shadow-xl shadow-charcoal/5 hover:-translate-y-1 transition-transform group"
                >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="w-full lg:w-3/5">
            <div className="bg-white rounded-xl p-6 md:p-6 sm:p-8 md:p-12 border border-dark/10 shadow-sm">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input 
                      ...
                      className="w-full bg-white border border-dark/20 px-4 py-3 text-dark focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-shadow"
                    />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <select className="w-full bg-white border border-dark/20 px-4 py-3 text-dark focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-shadow appearance-none cursor-pointer">
                ...
                <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-white border border-dark/20 px-4 py-3 text-dark focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-shadow resize-none"
                  ></textarea>
                </div>
                ...
                <button 
                  ...
                  className="w-full bg-accent hover:bg-accent/90 text-white font-bold py-4 transition-all shadow-lg flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed rounded-full"
                >
          ...
          <div className="w-full lg:w-2/5 space-y-8">
            ...
            <div className="bg-primary rounded-xl p-6 sm:p-8 text-white shadow-xl relative overflow-hidden">
      ...
      <section className="py-10 md:py-16 bg-white border-y border-dark/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            {LOCATIONS.map((loc) => (
              <div key={loc.id} className="bg-white rounded-xl p-4 border border-dark/10 flex flex-col md:flex-row gap-6">
                <div className="w-full md:w-2/5 aspect-video md:aspect-square rounded-xl overflow-hidden relative">
                  <img src={loc.mapUrl} alt={loc.name} className="w-full h-full object-cover" />
                  <div className="absolute inset-0 flex items-center justify-center bg-primary/20">
                    <div className="bg-white p-3 rounded-xl shadow-lg text-primary animate-bounce">
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {FAQS.map((faq, idx) => (
              <div key={idx} className="border border-dark/20 rounded-xl overflow-hidden shadow-sm bg-white">
                <button 
      ...
      <section className="py-12 md:py-20 bg-primary text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="tel:0244753849" className="bg-primary hover:bg-black text-white px-4 sm:px-8 py-4 font-bold transition-all shadow-xl flex items-center gap-2 rounded-full">
              <Phone className="w-5 h-5" /> Call Now
            </a>
            <a href="https://wa.me/233244753849" target="_blank" rel="noopener noreferrer" className="bg-white hover:bg-dark/5 text-[#25D366] px-4 sm:px-8 py-4 font-bold transition-all shadow-xl flex items-center gap-2 rounded-full">
