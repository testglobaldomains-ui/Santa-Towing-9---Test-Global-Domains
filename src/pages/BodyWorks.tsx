...
export default function BodyWorks() {
  ...
  return (
    <main className="pt-24 lg:pt-[104px] min-h-screen">
            ...
            {BODY_SERVICES.map((service, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white p-6 sm:p-8 rounded-xl shadow-sm border border-dark/10 hover:shadow-xl transition-all group flex flex-col"
                >
      ...
      <section className="py-16 md:py-24 bg-primary overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white/5 border border-white/10 rounded-xl p-4 md:p-6 sm:p-8">
              ...
              <div className="grid md:grid-cols-2 gap-4 md:gap-8 relative">
                ...
                <div className="relative rounded-xl overflow-hidden aspect-[4/3]">
                  ...
                  <div className="absolute top-4 right-4 bg-accent text-white px-4 py-1.5 rounded-xl text-sm font-bold shadow-md">
                    After
                  </div>
                </div>
              </div>
            ...
            {WHY_CHOOSE_US.map((feature, idx) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: idx * 0.1 }}
                  className="bg-white border border-dark/10 rounded-xl p-6 text-center hover:shadow-md transition-shadow group"
                >
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-primary rounded-xl p-6 sm:p-8 md:p-12 overflow-hidden relative flex flex-col md:flex-row items-center gap-12">
