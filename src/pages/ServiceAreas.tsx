      ...
      <div className="pt-24 pb-16 md:pb-20 bg-slate-50 min-h-screen">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
          ...
          {Object.keys(groupedAreas).length === 0 ? (
            <div className="bg-white rounded-xl p-6 sm:p-8 md:p-12 text-center border border-dark/10 shadow-sm">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="tel:0244753849" className="flex items-center gap-2 bg-primary hover:bg-dark text-white px-6 py-3 font-bold transition-colors w-full sm:w-auto justify-center rounded-full">
                  <Phone className="w-5 h-5" />
                  Call Now
                </a>
                <a href="https://wa.me/233244753849" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-[#25D366] hover:bg-dark text-white px-6 py-3 font-bold transition-colors w-full sm:w-auto justify-center rounded-full">
            ...
            <div className="space-y-12">
              {Object.entries(groupedAreas).map(([region, areas]) => (
                <div key={region} className="bg-white rounded-xl p-6 md:p-6 sm:p-8 border border-dark/10 shadow-sm">
          ...
          {/* CTAs */}
          <div className="mt-16 bg-dark text-white rounded-xl p-6 sm:p-8 md:p-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href="tel:0244753849" className="bg-primary hover:bg-white hover:text-dark text-white px-4 sm:px-8 py-4 font-bold transition-colors w-full sm:w-auto rounded-full">
                  Call Now: 024 475 3849
                </a>
                <a href="https://wa.me/233244753849" target="_blank" rel="noopener noreferrer" className="bg-accent hover:bg-white hover:text-dark text-dark px-4 sm:px-8 py-4 font-bold transition-colors w-full sm:w-auto rounded-full">
                  WhatsApp Us
                </a>
              </div>
            </div>
