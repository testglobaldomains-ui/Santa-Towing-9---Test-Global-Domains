      ...
      <section className="relative bg-primary overflow-hidden pt-16 pb-24 md:pt-24 md:pb-32">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <motion.form 
            ...
            className="max-w-2xl mx-auto bg-white p-2 rounded-xl flex items-center shadow-2xl"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16 lg:py-16 md:py-24">
        ...
        {activeCategory === 'All' && !searchQuery && (
          <section className="mb-20">
            ...
            <Link to={`/blog/${FEATURED_POST.id}`} className="group block relative rounded-xl overflow-hidden bg-white border border-dark/10 shadow-lg hover:shadow-xl transition-all">
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="w-full lg:w-2/3">
            ...
            {displayedPosts.length === 0 ? (
              <div className="text-center py-12 md:py-20 bg-slate-50 rounded-xl border border-dark/5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 mb-12">
                {displayedPosts.map((post, idx) => (
                  <motion.article 
                    ...
                    className="group flex flex-col bg-white rounded-xl border border-dark/10 overflow-hidden shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all"
                  >
                    ...
                    <div className="p-6 md:p-6 sm:p-8 flex-1 flex flex-col">
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-dark/10 mt-auto">
                        <div className="flex items-center gap-2">
                          <img src={post.authorImg} alt={post.author} className="w-8 h-8 rounded-xl" />
          ...
          <aside className="w-full lg:w-1/3 space-y-8">
            ...
            {/* Newsletter Widget */}
            <div className="bg-primary rounded-xl p-6 sm:p-8 text-white relative overflow-hidden shadow-xl">
      ...
      <section className="py-12 md:py-20 bg-primary text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a href="tel:0244753849" className="bg-white hover:bg-slate-100 text-primary px-4 sm:px-8 py-4 font-bold transition-all shadow-xl rounded-full">
              Call 0244 753 849
            </a>
          </div>
        </div>
