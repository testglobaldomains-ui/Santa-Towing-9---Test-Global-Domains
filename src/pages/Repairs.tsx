    ...
    <main className="pt-24 lg:pt-[104px] min-h-screen">
      ...
      <section className="relative bg-primary overflow-hidden pt-12 pb-32 md:pt-20 md:pb-40">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <Link to="/booking" className="bg-accent hover:bg-accent/90 text-white px-4 sm:px-8 py-4 font-bold transition-all shadow-lg shadow-accent/30 flex items-center justify-center rounded-full">
              Book for Repair
            </Link>
            <a href="tel:0244753849" className="bg-white/10 hover:bg-white/20 text-white backdrop-blur-md px-4 sm:px-8 py-4 font-bold transition-all border border-white/20 flex items-center justify-center gap-2 rounded-full">
            ...
            {REPAIR_SERVICES.map((service, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white p-6 rounded-xl shadow-sm border border-dark/10 hover:shadow-xl transition-all group flex flex-col"
                >
                  ...
                  <div className="mt-auto pt-4 border-t border-dark/10 space-y-2">
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                      <Link to={service.href || "/booking"} className="flex-1 bg-primary hover:bg-black text-white text-center py-2 px-2.5 text-xs font-bold transition-all flex items-center justify-center rounded-full">
                        <span>{service.href ? "Learn More" : "Book for Repair"}</span>
                      </Link>
                      <a href="tel:0244753849" className="flex-1 bg-accent hover:bg-accent/90 text-white text-center py-2 px-2.5 text-xs font-bold transition-all flex items-center justify-center gap-1 shadow-sm rounded-full">
      ...
      <section className="py-16 md:py-24 bg-white relative overflow-hidden">
        <div className="absolute right-0 top-1/2 -translate-y-1/2 w-1/3 h-[80%] bg-[url('https://i.ibb.co/23wLXy6t/Image-12-Tyre-Maintenance.jpg')] bg-cover bg-center rounded-xl hidden lg:block" />
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-2xl bg-primary rounded-xl p-6 md:p-6 sm:p-8 md:p-12 shadow-2xl">
            ...
            <form className="space-y-4" onSubmit={e => { e.preventDefault(); (e.target as HTMLFormElement).reset(); alert('Appointment booked successfully! We will contact you shortly.'); }}>
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <button type="submit" className="flex-1 bg-accent hover:bg-accent/90 text-white font-bold py-4 transition-all shadow-lg text-center rounded-full">
                  Book for Repair
                </button>
                <a href="tel:0244753849" className="flex-1 bg-white hover:bg-white/90 text-dark font-bold py-4 transition-all shadow-lg flex items-center justify-center gap-2 text-center rounded-full">
        ...
        <div className="flex gap-4 overflow-x-auto no-scrollbar pb-8 px-4 sm:px-6 lg:px-8 snap-x">
          {[
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ delay: idx * 0.1 }}
              className="w-[300px] md:w-[450px] aspect-[4/3] shrink-0 rounded-xl overflow-hidden snap-center"
            >
      ...
      <section className="py-16 md:py-24 bg-primary text-white text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/booking" className="bg-primary hover:bg-black text-white px-4 sm:px-8 py-4 font-bold transition-all shadow-xl flex items-center justify-center rounded-full">
              Book for Repair
            </Link>
            <a href="tel:0244753849" className="bg-accent hover:bg-accent/90 text-white px-4 sm:px-8 py-4 font-bold transition-all shadow-xl flex items-center justify-center gap-2 rounded-full">
              <Phone className="w-4 h-4" />
              <span>Call for Repair</span>
            </a>
          </div>
