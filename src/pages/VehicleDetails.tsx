        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white p-4 rounded-xl shadow-sm border border-dark/10">
              <div className="aspect-[16/10] relative rounded-xl overflow-hidden mb-4 group">
                ...
                <div className="absolute top-4 left-4 bg-accent text-white px-4 py-1.5 rounded-xl text-sm font-bold shadow-md">
                  New
                </div>
              </div>
                ...
                {activeTab === 'Financing' && (
                  <div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                      ...
                      <div className="bg-primary text-white rounded-xl p-6 sm:p-8 flex flex-col justify-center text-center relative overflow-hidden">
                        ...
                        <button className="w-full bg-white hover:bg-dark/5 text-dark font-bold py-4 transition-all rounded-full">
                          Apply for Financing
                        </button>
                      </div>
                    </div>
            ...
            {/* 10. FAQs */}
            <div className="bg-white rounded-xl shadow-sm border border-dark/10 p-6 sm:p-8">
              <h3 className="text-2xl font-bold text-dark mb-6">Frequently Asked Questions</h3>
              <div className="space-y-4">
                {VEHICLE_FAQS.map((faq, idx) => (
                  <div key={idx} className="border border-dark/20 rounded-xl overflow-hidden">
                    <button 
                ...
                return (
                  <>
                    <div className="w-full sm:w-1/2 flex justify-start">
                      {prevId && (
                        <Link to={`/sales/${prevId}`} className="group flex items-center gap-3 hover:bg-slate-50 p-3 rounded-xl transition-colors max-w-full">
                    ...
                    <div className="w-full sm:w-1/2 flex justify-end">
                      {nextId && (
                        <Link to={`/sales/${nextId}`} className="group flex items-center gap-3 hover:bg-slate-50 p-3 rounded-xl transition-colors max-w-full text-right">
                          <div className="overflow-hidden">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-[120px] space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-dark/10 p-6 md:p-6 sm:p-8">
                ...
                <div className="space-y-3">
                  <button className="w-full bg-accent hover:bg-accent/90 text-white font-bold py-4 transition-all shadow-md flex justify-center items-center gap-2 rounded-full">
                    Book a Test Drive
                  </button>
                  <button className="w-full bg-primary hover:bg-black text-white font-bold py-4 transition-all shadow-md flex justify-center items-center gap-2 rounded-full">
                    Enquire Now
                  </button>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-dark/10 p-6 md:p-6 sm:p-8">
                ...
                <div className="mt-6 aspect-[2/1] rounded-xl overflow-hidden bg-white relative">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
             {[
               ...
               { id: 8, type: 'Foreign Used', name: '2021 Lexus RX 350', price: 'GH₵ 680,000', image: 'https://i.ibb.co/j9GzSqt8/Image-9-Car-Battery-Maintenance.jpg' }
                ...
                <div key={idx} className="bg-white rounded-xl overflow-hidden border border-dark/10 shadow-sm hover:shadow-lg transition-all group flex flex-col">
                  <div className="aspect-[4/3] relative overflow-hidden bg-white">
                    ...
                    <div className="absolute top-4 left-4 bg-accent text-white px-3 py-1 rounded-xl text-xs font-bold shadow-sm">{vehicle.type}</div>
                  </div>
                  <div className="p-6">
                    ...
                    <Link to={`/sales/${vehicle.id}`} className="block w-full text-center bg-white border border-dark/20 hover:bg-white text-dark py-3 font-bold transition-colors text-sm rounded-full">
                      View Details
                    </Link>
                  </div>
                </div>
      ...
      <section className="py-16 md:py-24 bg-primary text-white text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button className="bg-accent hover:bg-accent/90 text-white px-4 sm:px-8 py-4 font-bold transition-all shadow-xl rounded-full">
              Book a Test Drive
            </button>
