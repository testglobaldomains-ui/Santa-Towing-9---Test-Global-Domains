  ...
  return (
    <main className="pt-24 lg:pt-[104px] min-h-screen">
      ...
      <section className="relative bg-primary overflow-hidden pt-12 pb-32 md:pt-24 md:pb-40">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <motion.div 
            ...
            className="max-w-2xl mx-auto bg-white p-2 rounded-xl flex items-center shadow-2xl mb-10"
          >
      ...
      <section className="relative z-20 -mt-12 mb-12 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-xl shadow-xl p-6 md:p-6 sm:p-8 border border-dark/10 flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            {CATEGORIES.map((cat, idx) => {
              ...
              return (
                <Link 
                  ...
                  className="bg-white rounded-xl overflow-hidden group hover:shadow-lg transition-shadow border border-dark/10"
                >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {filteredProducts.map((product, idx) => (
              <motion.div
                ...
                className="bg-white rounded-xl p-4 border border-dark/10 hover:shadow-xl transition-all group flex flex-col"
              >
                <div className="aspect-[4/3] rounded-xl overflow-hidden mb-6 relative bg-white">
                  ...
                  <div className="absolute top-3 left-3 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-xl text-xs font-bold text-dark shadow-sm">
                    {product.brand}
                  </div>
                </div>
