        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div 
              ...
              className="bg-white rounded-xl p-6 md:p-6 sm:p-8 shadow-2xl relative"
            >
            ...
            {TOWING_FEATURES.map((feature, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white rounded-xl p-6 shadow-sm border border-dark/10 flex flex-col items-center text-center hover:shadow-xl hover:border-accent/30 transition-all group"
                >
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="bg-white rounded-xl overflow-hidden aspect-square relative shadow-xl border-8 border-white">
              {/* Map Placeholder */}
              ...
              <div className="absolute bottom-8 left-8 right-8 bg-white/90 backdrop-blur-md rounded-xl p-6 shadow-xl">
