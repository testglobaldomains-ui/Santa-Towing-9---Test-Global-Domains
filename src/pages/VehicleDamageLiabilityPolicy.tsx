  ...
  return (
    <div className="pt-24 pb-16 md:pb-20 bg-slate-50 min-h-screen">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <div className="bg-white p-6 sm:p-8 md:p-12 rounded-xl shadow-sm border border-dark/10">
            ...
            <div className="bg-slate-50 p-6 rounded-xl mt-6 border border-dark/10 flex flex-col sm:flex-row gap-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:santatowing.garage@gmail.com" className="text-dark/70 hover:text-accent transition-colors">santatowing.garage@gmail.com</a>
                </div>
              </div>
            </div>
          </div>
