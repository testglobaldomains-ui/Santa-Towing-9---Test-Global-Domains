        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {PERKS.map((perk, idx) => {
              ...
              return (
                <div key={idx} className="bg-white rounded-xl p-6 sm:p-8 border border-dark/10 hover:shadow-xl transition-all hover:-translate-y-1 group">
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="w-full lg:w-1/2 space-y-6">
              ...
              <div className="pt-4 flex gap-4">
                <div className="bg-dark p-4 rounded-xl text-center flex-1 border border-white/20">
            ...
            <div className="w-full lg:w-1/2">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <img 
                  ...
                  className="rounded-xl w-full h-48 lg:h-64 object-cover"
                />
                <img 
                  src="https://i.ibb.co/WpyLYZQk/Image-15-Car-Lightening-maintenance.jpg" 
                  alt="Customer service" 
                  className="rounded-xl w-full h-48 lg:h-64 object-cover translate-y-8"
                />
              </div>
            </div>
          </div>
            ...
            <AnimatePresence>
              {filteredJobs.map((job) => (
                <motion.div 
                  ...
                  className="bg-white border border-dark/20 rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow"
                >
                  {/* Job Header (Always visible) */}
                  <div 
                    onClick={() => setExpandedJobId(expandedJobId === job.id ? null : job.id)}
                    className="p-6 md:p-6 sm:p-8 flex flex-col md:flex-row md:items-center justify-between gap-4 cursor-pointer hover:bg-white transition-colors rounded-full"
                  >
                    <div>
                      ...
                      <div className="flex flex-wrap gap-4 text-sm text-dark/70 font-medium">
                        <span className="flex items-center gap-1 bg-white px-3 py-1 rounded-xl text-dark"><Briefcase className="w-4 h-4" /> {job.department}</span>
                  ...
                  <AnimatePresence>
                    {expandedJobId === job.id && (
                      ...
                      >
                        <div className="p-6 md:p-6 sm:p-8 border-t border-dark/10 bg-white flex flex-col lg:flex-row gap-8">
                              ...
                              <ul className="space-y-2">
                                {job.responsibilities.map((req, i) => (
                                  <li key={i} className="flex items-start gap-2 text-dark/70">
                                    <div className="w-1.5 h-1.5 rounded-xl bg-primary mt-2 shrink-0" />
                          ...
                          <div className="w-full lg:w-1/3">
                            <div className="bg-white p-6 rounded-xl border border-dark/20 shadow-sm sticky top-32">
                              ...
                              {!isApplyingFor || isApplyingFor !== job.id ? (
                                ...
                                <div className="text-center p-4 bg-white rounded-xl border border-dark/20">
                  ...
                  <AnimatePresence>
                    {isApplyingFor === job.id && (
                      ...
                      >
                        <div className="p-6 md:p-6 sm:p-8 md:p-10 border-t border-white/20 relative">
                          <button 
              ...
              {filteredJobs.length === 0 && (
                <div className="text-center py-12 bg-white rounded-xl border border-dark/20">
