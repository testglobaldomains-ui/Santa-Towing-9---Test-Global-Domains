      ...
      <section className="relative bg-primary text-white py-16 md:py-16 md:py-24 lg:py-32 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <motion.div 
            ...
            className="bg-white p-2 rounded-xl flex items-center shadow-2xl max-w-2xl mx-auto border border-dark/10"
          >
      ...
      <section className="py-12 md:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {filteredFaqs.length === 0 ? (
            <div className="text-center py-12 md:py-20 bg-white rounded-xl border border-dark/10 shadow-sm">
                  ...
                  <div key={category}>
                    ...
                    <div className="space-y-4">
                      {(faqs as typeof FAQ_DATA).map((faq, idx) => {
                        ...
                        return (
                          <div key={idx} className="border border-dark/20 rounded-xl overflow-hidden shadow-sm bg-white hover:border-accent/30 transition-colors">
                            <button 
      ...
      <section className="py-12 md:py-20 bg-white border-t border-dark/20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="https://wa.me/233244753849" target="_blank" rel="noopener noreferrer" className="bg-primary/50 hover:bg-accent text-white px-4 sm:px-8 py-4 font-bold transition-all shadow-xl flex items-center justify-center gap-2 rounded-full">
