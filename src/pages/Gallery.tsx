    ...
    <main className="pt-24 lg:pt-[104px] min-h-screen bg-white">
      ...
      <section className="py-12 md:py-20 bg-primary text-white overflow-hidden relative">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <div 
            ref={sliderRef}
            className="relative w-full aspect-[4/3] md:aspect-[16/9] rounded-xl overflow-hidden cursor-ew-resize select-none touch-none shadow-2xl"
          ...
          >
            ...
            >
              <img 
                ...
                draggable="false"
              />
              <div className="absolute top-4 left-4 bg-primary/80 backdrop-blur-md text-white text-xs font-bold px-3 py-1.5 rounded-xl shadow-lg">
                Before
              </div>
            </div>

            <div className="absolute top-4 right-4 bg-primary text-white text-xs font-bold px-3 py-1.5 rounded-xl shadow-lg z-20">
              After
            </div>
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {VIDEOS.map((video) => (
              <div key={video.id} className="group relative rounded-xl overflow-hidden aspect-video bg-white cursor-pointer shadow-sm hover:shadow-xl transition-all border border-dark/10">
      ...
      <section className="py-12 md:py-20 bg-white border-t border-dark/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[1,2,3,4].map((i) => (
              <div key={i} className="aspect-square bg-white rounded-xl overflow-hidden relative group">
                <img 
      ...
      <section className="py-12 md:py-20 bg-primary text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/booking" className="bg-primary hover:bg-black text-white px-4 sm:px-8 py-4 font-bold transition-all shadow-xl text-lg inline-block rounded-full">
              Book a Service
            </Link>
