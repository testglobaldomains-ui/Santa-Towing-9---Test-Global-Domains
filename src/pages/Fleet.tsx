            ...
            {FLEET_SERVICES.map((service, idx) => {
              ...
              return (
                <motion.div 
                  ...
                  className="bg-white rounded-xl p-6 sm:p-8 border border-dark/10 hover:shadow-xl transition-all group"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 lg:gap-10">
            {WHY_CHOOSE_US_FLEET.map((item, idx) => {
              ...
              return (
                <div key={idx} className="flex flex-col items-center text-center p-6 bg-white/5 border border-white/10 rounded-xl backdrop-blur-sm">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {INDUSTRIES.map((ind, idx) => {
              const Icon = ind.icon;
              return (
                <div key={idx} className="relative rounded-xl overflow-hidden group h-64">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            ...
            <div className="grid lg:grid-cols-5 gap-8 lg:gap-4 relative z-10">
              {STEPS.map((step, idx) => (
                <div key={idx} className="bg-white p-6 rounded-xl border border-dark/10 shadow-xl shadow-charcoal/5 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-1/2 relative">
              ...
              <div className="relative bg-white/10 backdrop-blur-xl border border-white/20 rounded-xl p-4 shadow-2xl">
                <div className="bg-white rounded-xl overflow-hidden aspect-video shadow-inner flex items-center justify-center relative">
                  <img 
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-primary/80 to-transparent flex items-end p-6">
                     <div className="bg-white/90 backdrop-blur-sm p-4 rounded-xl shadow-lg w-full max-w-sm">
                       ...
                       <div className="w-full bg-white rounded-xl h-2">
                         <div className="bg-primary/50 h-2 rounded-xl" style={{ width: '98%' }}></div>
                       </div>
                     </div>
                  </div>
                </div>
