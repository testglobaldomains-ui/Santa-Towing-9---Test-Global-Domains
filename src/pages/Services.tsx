    ...
    <main className="pt-24 lg:pt-[104px]">
      ...
      <section className="py-12 md:py-20 bg-white text-center">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="w-24 h-1 bg-primary mx-auto rounded-xl" />
        </div>
      </section>
            ...
            {CORE_SERVICES.map((service, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-2xl border border-dark/10 transition-all duration-300 flex flex-col h-full"
                >
                  ...
                  <div className="p-6 sm:p-6 sm:p-8 flex-1 flex flex-col relative z-10 bg-white">
                    ...
                    <div className="mt-auto pt-4 border-t border-dark/10 space-y-3">
                      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                        <Link to={servicePath} className="flex-1 bg-primary hover:bg-black text-white text-center py-2 px-2.5 text-xs font-bold transition-all flex items-center justify-center rounded-full">
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-primary rounded-xl overflow-hidden flex flex-col md:flex-row relative">
      ...
      <section className="py-16 md:py-24 bg-primary text-white text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a href="tel:0244753849" className="bg-white hover:bg-dark/5 text-dark px-4 sm:px-8 py-4 font-bold transition-all shadow-xl flex items-center justify-center rounded-full">
              Call Now
            </a>
          </div>
        </div>
