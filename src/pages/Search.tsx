      ...
      <>
        {parts.map((part, i) => 
          part.toLowerCase() === highlight.toLowerCase() ? (
            <span key={i} className="bg-accent/20 text-dark font-semibold rounded-xl px-0.5">{part}</span>
          ) : (
  ...
  return (
    <main className="min-h-screen bg-slate-50 pt-24 pb-16 md:pb-20">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-dark/10 p-6 md:p-6 sm:p-8 md:p-10 mb-8">
          ...
          <div className="space-y-6">
            ...
            {results.length > 0 ? (
                  ...
                  >
                    ...
                    >
                      <div className="flex items-start gap-4">
                        <div className="bg-slate-50 p-3 rounded-xl shrink-0 group-hover:bg-primary/10 transition-colors">
              ...
              <motion.div 
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                className="bg-white p-6 sm:p-8 md:p-12 rounded-xl text-center border border-dark/10 border-dashed"
              >
