      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="flex flex-col lg:flex-row gap-12 relative">
          ...
          <div className="w-full lg:w-2/3">
                ...
                return (
                  <>
                    <div className="w-full sm:w-1/2 flex justify-start">
                      {prevPost && (
                        <Link to={`/blog/${prevPost.id}`} className="group flex items-center gap-3 hover:bg-slate-50 p-3 rounded-xl transition-colors max-w-full">
                    ...
                    <div className="w-full sm:w-1/2 flex justify-end">
                      {nextPost && (
                        <Link to={`/blog/${nextPost.id}`} className="group flex items-center gap-3 hover:bg-slate-50 p-3 rounded-xl transition-colors max-w-full text-right">
                          <div className="overflow-hidden">
            ...
            <div className="bg-primary text-white rounded-xl p-6 sm:p-8 shadow-xl relative overflow-hidden mb-12">
              ...
              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div className="flex flex-col gap-3 w-full md:w-auto shrink-0">
                  <a href="tel:0244753849" className="bg-accent hover:bg-accent/90 text-white font-bold px-6 py-3 text-center transition-all shadow-md rounded-full">
                    Call 0244 753 849
                  </a>
          ...
          <aside className="w-full lg:w-1/3">
            <div className="sticky top-[160px] space-y-8">
              ...
              {/* Author Bio */}
              <div className="bg-slate-50 rounded-xl p-6 border border-dark/5 shadow-sm text-center">
              ...
              <div className="bg-white rounded-xl border border-dark/10 shadow-sm overflow-hidden">
