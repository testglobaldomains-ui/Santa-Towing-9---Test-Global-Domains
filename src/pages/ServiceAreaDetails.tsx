      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="mb-12">
          ...
          <div className="mt-6">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-xl border border-dark/10 shadow-sm mb-12">
              <div className="prose prose-slate max-w-none text-dark/80 whitespace-pre-wrap">
                {advert.description}
              </div>
              
              <div className="mt-8 flex flex-col sm:flex-row gap-4">
                <a href="tel:0244753849" className="bg-primary hover:bg-dark text-white px-4 sm:px-8 py-3 font-bold transition-colors text-center inline-block rounded-full">
                  Call Now: 024 475 3849
                </a>
                <a href="https://wa.me/233244753849" target="_blank" rel="noopener noreferrer" className="bg-accent hover:bg-dark text-dark hover:text-white px-4 sm:px-8 py-3 font-bold transition-colors text-center inline-block rounded-full">
                  WhatsApp Us
                </a>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          {STANDARD_SERVICES.map((service) => {
            ...
            return (
              ...
              >
                <div className="w-12 h-12 rounded-lg bg-[#192C2C] flex items-center justify-center shrink-0 group-hover:bg-white transition-colors">
